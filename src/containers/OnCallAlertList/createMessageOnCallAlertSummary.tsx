...
//[TODO]
import {
  getOnCallAlertInitiallSelected,
  getReplyTypeId,
} from './createMessageOnCallAlertSummary.helpers';
//[TODO]
...
export const CreateMessageOnCallAlertSummary = () => {
  ...
  const fetchOnCallAlert = async () => {
    await dispatch(fetchOnCallAlertDocument(+id!));
  };
  ...
  useEffect(() => {
    if (!onCallAlertDocument) fetchOnCallAlert();
